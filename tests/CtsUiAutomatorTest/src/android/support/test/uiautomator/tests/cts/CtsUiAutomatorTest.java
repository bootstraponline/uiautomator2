...
public class CtsUiAutomatorTest extends UiAutomatorTestCase {
    ...
    private static final String PKG_NAME = "android.support.test.uiautomator.tests.cts.testapp";
   ...
   /**
    ...
    public void testSelectorResourceId() throws UiObjectNotFoundException {
        ...
        UiSelector toggleSelector =
                new UiSelector().resourceId("android.support.test.uiautomator.tests.cts.testapp:id/test_5_toggleButton");
